...
cmd({
    ...
    try {
        ...
        const doneMessage = "> *GHAFFAR-MD PAIRING COMPLETED*";
...
cmd({
    ...
    try {
        ...
        const sentMessage = await conn.sendMessage(from, {
            ...
            caption: `- *Pairing Code For GHAFFAR-MD ⚡*\n\n Notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *GHAFFAR-MD* session id.\n\n*🔢 Pairing Code*: *${pairingCode}*\n\n> *Copy it from below message 👇🏻*`
        }, { quoted: m });
